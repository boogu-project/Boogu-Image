...
export device="npu:0"
export rewriter_device='npu:1' # Could be different from the main device, e.g., 'npu:1'
...
experiment_name=demo_ti2i_batch_local_reasoning
instruction=""
...
case_name=ti2i_batch_example1_local_reasoning_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
