...
export device="npu:0"
export rewriter_device='npu:1' # npu:0 is the main device, npu:1 is the rewriter device
...
experiment_name=demo_t2i_local_reasoning_for_ppt_design
instruction="Create a single PPT slide illustrating the various use cases of AI Agents."
# instruction="画一页的PPT slide，要求讲解AI Agent的各种应用场景。"
...
case_name=t2i_ppt_design_en_local_reasoning_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
# case_name=t2i_ppt_design_zh_local_reasoning_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
