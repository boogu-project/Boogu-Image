...
experiment_name=demo_t2i_custom_rewrite_system_prompts
...
case_name=t2i_oldman_en_custom_rewrite_system_prompts_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
