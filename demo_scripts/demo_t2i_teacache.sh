...
experiment_name=demo_t2i_teacache
...
# case_name=t2i_oldman_en_teacache_int${bog_interval}_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
case_name=t2i_oldman_zh_teacache_all_layers_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
