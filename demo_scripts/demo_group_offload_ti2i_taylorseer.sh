...
experiment_name=demo_group_offload_ti2i_taylorseer
...
case_name=ti2i_rm_dog_group_offload_taylorseer_all_layers_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
