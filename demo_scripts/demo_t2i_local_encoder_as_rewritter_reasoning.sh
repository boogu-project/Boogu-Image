...
export rewriter_device="${rewriter_device:-$device}" # Must be the same as the main device
...
experiment_name=demo_t2i_local_encoder_as_rewritter_reasoning
...
case_name=t2i_oldman_zh_local_encoder_as_rewritter_reasoning_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
