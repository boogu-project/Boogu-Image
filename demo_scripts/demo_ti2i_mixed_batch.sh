...
experiment_name=demo_ti2i_mixed_batch
instruction=""
...
case_name=ti2i_mixed_batch_example1_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
