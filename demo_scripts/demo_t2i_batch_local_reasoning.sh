...
export rewriter_device="${rewriter_device:-$device}"
enable_inner_devices_manager=True
###########################################################
...
experiment_name=demo_t2i_batch_local_reasoning
instruction=""
...
batch_data_config_path="./batch_data_samples/t2i_batch_data_sample.yml" # disable when use_batch_inference is False
...
case_name=t2i_batch_example1_local_reasoning_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
