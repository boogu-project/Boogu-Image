...
export rewriter_device='cuda:1' # Could be different from the main device
...
experiment_name=demo_seq_offload_ti2i_local_reasoning
...
case_name=ti2i_persimmons_en_seq_offload_local_reasoning_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
# case_name=ti2i_persimmons_zh_seq_offload_local_reasoning_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
