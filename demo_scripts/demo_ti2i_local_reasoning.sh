...
experiment_name=demo_ti2i_local_reasoning
...
case_name=ti2i_persimmons_local_reasoning_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
