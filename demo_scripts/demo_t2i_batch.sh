...
experiment_name=demo_t2i_batch
instruction=""
...
case_name=t2i_batch_example1_${resolution}_steps${num_inference_steps}_tg${text_guidance_scale}_ig${image_guidance_scale}_seed${seed}
